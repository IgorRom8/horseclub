...
const IMG = {
  ...
  postoy: siteImages.servicePostoy,

  train: siteImages.serviceTrain,

  feed: siteImages.serviceFeed,
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 mx-auto flex h-full max-w-6xl flex-col justify-center gap-5 px-4 py-10">
          ...
          <p className="max-w-xl text-lg font-medium leading-relaxed text-white drop-shadow-[0_2px_12px_rgb(0_0_0/0.85)] opacity-0 motion-safe:animate-fade-up motion-safe:animate-delay-600">
            ...
            Постой, тренировки, понятная инфраструктура и регламент площадки.
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 md:py-20">
        ...
        <FadeIn>
          ...
          <h2 className="font-serif text-3xl font-semibold tracking-tight text-accent md:text-4xl">Услуги</h2>

          <p className="mt-3 max-w-2xl text-base leading-relaxed text-neutral-600">

            Три направления: размещение лошади, занятия с тренером, кормление по рациону.
      ...
      <section className="relative border-y border-sand/90 bg-gradient-to-br from-sand/90 via-[#faf6ef] to-sand shadow-inner">
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-4 py-14 md:grid-cols-2 md:items-center md:gap-12">
          ...
          <FadeIn>
            ...
            <h2 className="font-serif text-3xl font-semibold tracking-tight text-accent md:text-4xl">Инфраструктура</h2>
            ...
            <ul className="mt-8 space-y-7 text-neutral-800">
              ...
              <li className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm leading-relaxed text-neutral-600">Подготовленные боксы с системой содержания.</p>
          ...
          <FadeIn delay={100}>
            ...
            <div className="group relative aspect-[4/3] overflow-hidden rounded-2xl border border-white/70 bg-white shadow-lift ring-1 ring-black/5">
              ...
              <Image
                ...
                src={siteImages.infrastructureAside}
      ...
      <section className="mx-auto max-w-6xl border-t border-sand/70 px-4 py-16 md:py-20">
        ...
        <FadeIn>
          ...
          <h2 className="font-serif text-3xl font-semibold tracking-tight text-accent md:text-4xl">Оставить заявку</h2>
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 md:py-20">
        ...
        <FadeIn>
          ...
          <h2 className="font-serif text-3xl font-semibold tracking-tight text-accent md:text-4xl">Связь с менеджером</h2>
