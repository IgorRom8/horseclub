  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-12">
      ...
      <FadeIn className="mt-10" delay={60}>
        <div className="rounded-2xl border border-sand/90 bg-gradient-to-br from-white/95 to-sand/40 p-6 shadow-soft ring-1 ring-black/[0.04] md:p-8">
      ...
      <FadeIn className="mt-8" delay={80}>
        <div className="overflow-hidden rounded-lg border border-sand bg-sand">
          <iframe
            title="Карта"
            src={mapSrc}
            width="100%"
      ...
      <FadeIn className="mt-12" delay={120}>
        <ManagerContactBlock />
      </FadeIn>
    </div>
  );
